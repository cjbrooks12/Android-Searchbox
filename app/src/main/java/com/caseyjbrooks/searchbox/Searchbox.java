package com.caseyjbrooks.searchbox;
...
public class Searchbox extends RelativeLayout {
    ...
    private void initialize(Context context, AttributeSet attrs, int defStyle) {
        ...
        if(a.hasValue(R.styleable.SearchBox_hint) && a.getResourceId(R.styleable.SearchBox_hint, 0) > 0) {
            this.setHint(a.getString(R.styleable.SearchBox_hint));
        }
        else if(a.hasValue(R.styleable.SearchBox_hint) && a.getResourceId(R.styleable.SearchBox_hint, 0) == 0) {
            this.setHint(a.getNonResourceString(R.styleable.SearchBox_hint));
        }
